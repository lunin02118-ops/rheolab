//! AI-context candidate extraction — picks header rows from a rheology file
//! and packages them as [`AiContextCandidate`]s ranked for the AI mapper.
//!
//! Inputs: raw rows (flat 2D matrix) or a Calamine workbook.
//! Outputs: up to 3 ranked candidates, ordered by heuristic score.
