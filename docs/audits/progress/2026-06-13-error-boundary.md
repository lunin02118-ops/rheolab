...
Commit: 50f95d0
PR: not opened
Phase: PR-002 - Clean error serialization and IPC error boundary helper
Date: 2026-06-13
Agent: Codex
...
| `cargo test --manifest-path src-tauri\Cargo.toml -- --test-threads=1` | 0 | Passed: 505 lib tests, 30 `ai_parsing`, 12 `db_integrity`, 10 `ipc_contracts`, doc-test ignored. |
