...
| 003  | Закрыть moderate-advisory uuid (GHSA-w5hq-g745-h8pq) в dev-deps через npm overrides | P2 | S | 002 | TODO |
| 004  | Release-gate проверка боевого license_public.der (не dev-ключ) | P2 | S | — (удобнее после 002) | TODO |
