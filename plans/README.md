...
| 008  | Окно «О программе» с вкладками лицензии и поддержки | P2 | M | — | DONE (2026-06-12, ветка codex/008-about-support-dialog; version:validate/lint/typecheck/targeted Vitest/Playwright smoke/release:prepare/deploy alpha/alpha HMAC smoke/server:doctor — exit 0) |
