...
Владелец явно расширил задачу после составления плана: реализовать 008 и
сразу сделать deploy на alpha-канал. Это отменяет исходное ограничение плана
«не деплоить и не делать release bump» только для выпуска
`0.2.3-alpha.21`; остальной scope 008 не менялся.
...
- Исходный план запрещал deploy/release bump, но поправка 2026-06-12
  разрешила alpha bump/deploy для `0.2.3-alpha.21`.
