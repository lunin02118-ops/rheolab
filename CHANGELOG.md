...
## [0.2.3-alpha.23] — 2026-06-12

> UI-hotfix окна «О программе» после ревью alpha-интерфейса.

### Исправлено
- **О программе / Контакты**: оставлен единый email `info@rheolab.site`; отдельный `support@rheolab.site` и дублирующая кнопка поддержки убраны.
- **Настройки**: старый блок `О программе` удалён из настроек, чтобы версия и обновления не дублировались частично.
- **О программе**: окно разделено на три вкладки: `Лицензия`, `Обновления`, `Контакты`; header-кнопка открывает вкладку `Обновления`, а CTA активации — `Лицензия`.
- **Обновления**: версия, канал, дата сборки, контрольный хеш и ручная проверка обновлений вынесены в отдельную вкладку.
