...
use crate::reports::application::generate_by_ids::{
    generate_comparison_excel_by_ids_bytes_cached_with_job,
    generate_comparison_pdf_by_ids_bytes_cached_with_job,
};
use crate::reports::application::generate_single::{
    generate_excel_by_id_bytes_cached_with_job, generate_pdf_by_id_bytes_cached_with_job,
};
pub use crate::reports::domain::*;
use crate::reports::render::excel::render_excel_from_input;
use crate::reports::render::pdf::render_pdf_from_input;
use crate::runtime::jobs::JobKind;
use crate::state::AppState;
use crate::utils::validation::{validate_bounded_str, validate_hash_id};
#[cfg(any(test, debug_assertions))]
use rheolab_core::report_generator::comparison::{ComparisonChartConfig, ComparisonReportInput};
...
mod tests {
    ...
    use crate::reports::application::comparison::{
        ...
        build_comparison_report_input_by_ids_cached, build_expert_settings, build_schedule_config,
    };
    use crate::reports::application::generate_by_ids::{
    ...
    use crate::reports::application::generate_single::build_report_input_by_id_cached_with_job;
    ...
    fn valid_by_ids_request() -> ComparisonReportByIdsRequest {
        ComparisonReportByIdsRequest {
            ...
            settings: ComparisonReportByIdsSettings {
                ...
                analysis_settings:
                    crate::reports::domain::options::default_comparison_analysis_settings(),
